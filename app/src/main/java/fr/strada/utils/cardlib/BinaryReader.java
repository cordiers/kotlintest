...
public class BinaryReader  {
    ...
    public Date readFileTime() {
        UnsignedInteger hundredsOfNanosecondsSinceJan11601 = readDWord();
        long millisecondsSinceJan11601 = hundredsOfNanosecondsSinceJan11601.dividedBy(UnsignedInteger.valueOf(10000)).longValue();
    ...
    {
        Date timeReal = ByteConverter.ToDateTime(ReadTimeRealBytes());
        return timeReal;
    }

    public Word ReadWord()
    {
        byte wordB1 = readByte();
        byte wordB2 = readByte();
        Word word = new Word(wordB1, wordB2);
        return word;
    }
