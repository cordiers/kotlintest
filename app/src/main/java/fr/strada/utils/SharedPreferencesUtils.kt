...
object SharedPreferencesUtils {
    ...
    var idToken: String?
     ...
     fun savePreferencesString(key: String, value: String) {
        PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).edit().putString(key, value).apply()
    }

     fun getPreferencesString(key: String, defaultValue: String): String? {
        return PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).getString(key, defaultValue)
    }

     fun savePreferencesBoolean(key: String, value: Boolean) {
        PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).edit().putBoolean(key, value).apply()
    }

     fun getPreferencesBoolean(key: String, defaultValue: Boolean): Boolean {
        return PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).getBoolean(key, defaultValue)
    }

     fun savePreferencesInt(key: String, value: Int) {
        PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).edit().putInt(key, value).apply()
    }

     fun getPreferencesInt(key: String, defaultValue: Int): Int {
        return PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).getInt(key, defaultValue)
    }

    fun clear(){
        PreferenceManager.getDefaultSharedPreferences(StradaApp.instance).edit().clear().apply()
    }
