...
public class UTCPicker extends View {
    ...
    public UTCPicker(Context context) {
        this(context, null);
    }

    public UTCPicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UTCPicker(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public UTCPicker setStartNumber(int startNumber) {
    ...
    public UTCPicker setEndNumber(int endNumber) {
    ...
    public UTCPicker setCurrentNumber(int currentNumber) {
    ...
    public UTCPicker setRowNumber(int rowNumber) {
    ...
    public UTCPicker setTextColor(int color) {
        mTextColor = color;
        initPaint();
        invalidate();
        return this;
    ...
    public UTCPicker setFlagTextColor(int color) {
    ...
    public UTCPicker setTextSize(float textSize) {
        mTextSize = textSize;
        init();
        invalidate();
        return this;
    ...
    public UTCPicker setFlagTextSize(float textSize) {
    ...
    public UTCPicker setBackground(int color) {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(UTCPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(UTCPicker picker, int scrollState);
    }

    public UTCPicker setOnScrollListener(OnScrollListener l) {
        mOnScrollListener = l;
        return this;
    }

    public UTCPicker setOnValueChangeListener(OnValueChangeListener l) {
     ...
     * @param textArray
     */
    public UTCPicker setCustomTextArray(String[] textArray) {
