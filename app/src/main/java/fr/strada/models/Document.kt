...
open class Document : RealmObject , Comparable<Document>{
    ...
    constructor()
    constructor(docId : String, docName: String, docEcheance: String, notification: Boolean, currentJourNotfication: Int, file: String , file1: String ,
                file2: String,emailUser:String) : super() {
        this.docId = docId
