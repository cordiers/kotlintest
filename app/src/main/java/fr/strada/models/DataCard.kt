...
class DataCard {
    ...
    constructor(FileId: String,DataLength: String, resultData: String, resultSignatureData: String , cardType : String) {
        this.FileId = FileId
    ...
    fun toString(lengh : Int,Appendix : Int): String {
        if (resultData.isEmpty()) return ""
        return toStringData(lengh,(Appendix-1).toString()) + toStringSignatureData(Appendix.toString())
    }
