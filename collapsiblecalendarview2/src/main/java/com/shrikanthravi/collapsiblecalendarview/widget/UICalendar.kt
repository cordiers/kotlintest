...
abstract class UICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    var firstDayOfWeek = PreferenceManager.getDefaultSharedPreferences(context).getInt("FIRST_DAY_MONTH", MONDAY)
    ...
    var todayItemBackgroundDrawable = ContextCompat.getDrawable(context,R.drawable.circle_black_stroke_background)
    ...
    var selectedItemBackgroundDrawable = ContextCompat.getDrawable(context,R.drawable.circle_black_solid_background)
    ...
    protected fun setAttributes(attrs: TypedArray) {
        ...
        selectedItemBackgroundDrawable = if (selectedItemBackgroundDrawable != null) {
        ...
        buttonLeftDrawable = if (buttonLeftDrawable != null) {
            buttonLeftDrawable
        } else {
            this.buttonLeftDrawable
        }

        var buttonRightDrawable = attrs.getDrawable(R.styleable.UICalendar_buttonRight_drawable)
        buttonRightDrawable = if (buttonRightDrawable != null) {
            buttonRightDrawable
        } else {
            this.buttonRightDrawable
        }
